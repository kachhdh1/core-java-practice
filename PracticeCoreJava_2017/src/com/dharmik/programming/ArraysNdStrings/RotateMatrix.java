...
/**
 * This class rotates matrix with the help of a buffer
 * @author dharmik
 *
 */
public class RotateMatrix {
	...
	private int[][] rotateMatrixBy90DegreeCounterClockwise(int[][] matrix) {
		...
		int totalRowsOfRotatedMatrix = matrix[0].length; // Total columns of
															// Original Matrix
		int totalColsOfRotatedMatrix = matrix.length; // Total rows of Original
														// Matrix
