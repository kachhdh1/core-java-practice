...
public class CustomLinkedListDriver {
	...
	public static void main(String[] args) {
		...
		System.out.println(trainApp.trainSize());
		
		//first stop, we remove a car and add a couple more
		trainApp.firstStop();

		//print out the train size
		System.out.println("After First Stop train size: " + trainApp.trainSize());

		//second stop, we need to remove all the tankers
		trainApp.secondStop();

		//print out the train size
		System.out.println("After Second Stop train size: " + trainApp.trainSize());
	...
	class TrainCar {
		...
		private CustomLinkedListDriver getOuterType() {
			return CustomLinkedListDriver.this;
		}
	...
	public void buildTrainWithDuplicateData() {
		// build the train for it's initial trip
		TrainCar car1 = new TrainCar(CarType.BOXCAR, "Amazon Packages");
